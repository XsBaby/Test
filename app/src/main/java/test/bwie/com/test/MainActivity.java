...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = "http://169.254.30.70/mobile/index.php?act=goods_class&gc_id=1";
            ...
            public void onResponse(String response) {
                ...
                new Thread() {
                    ...
                    public void run() {
                        ...
                        for (int i = 0; i < list2.size(); i++) {
                            String url = "http://169.254.30.70/mobile/index.php?act=goods_class&gc_id=" + list2.get(i).getGc_id();
